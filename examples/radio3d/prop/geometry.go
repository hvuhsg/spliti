// Package prop is a GPU-free, unit-tested radio-propagation model: a scene made
// of planar faces, line-of-sight queries, image-method specular reflections,
// free-space path loss, a complex multipath sum, and a coverage grid. It is the
// physics layer of the radio3d example and never imports the renderer, so it runs
// (and tests) without a GPU.
//
